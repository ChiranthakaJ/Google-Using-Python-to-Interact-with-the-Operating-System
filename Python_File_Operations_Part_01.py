...
file = open("Python_File_Sample_V1.txt")  #This path is a relative path, which doesn't want to say the drive location and the root folder the file in. This is more accurate and error free method.
